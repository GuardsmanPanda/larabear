            ...
            @foreach($errors as $error)
                <tr class="hover:bg-sky-50">
                    ...
                    <td class="px-2.5">
                        ...
                        <x-bear::buttonOutline color="red" icon="trash" size="tiny" class="pl-2" hx-delete='{{"/bear/log/error?error_namespace=$error->error_namespace&error_key=$error->error_key"}}' tippy="Delete all errors with same Namespace + Key">Key</x-bear::buttonOutline>
