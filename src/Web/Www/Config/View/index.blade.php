...
<x-bear::heading.h1-section subtitle="A list of all roles in the system.">Application Configuration
    <x-slot name="extra">
        <x-bear::button.dark icon="wrench" hx-get="/bear/config/create" hx-target="#dialog-content">New Config</x-bear::button.dark>
    </x-slot>
...
<x-bear::table.layout.standard>
    ...
    @foreach($configs as $config)
        <tr class="hover:bg-sky-50">
            ...
            <td class="px-2">
                <x-bear::button.outline icon="pencil" size="tiny" hx-get='{{"/bear/config/$config->config_key/update"}}' hx-target="#dialog-content">Edit</x-bear::button.outline>
