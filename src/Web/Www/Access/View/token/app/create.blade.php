...
<x-bear::dialog.create title="New API Access Token" hx-post="/bear/access/token/app" class="w-[50rem]">
    <x-bear::section.basic title="Quick Actions">
        <x-bear::button.dark icon="eye" hx-get="/bear/access/token/app/create?type=monitoring" hx-target="#dialog-content">Monitoring Token</x-bear::button.dark>
