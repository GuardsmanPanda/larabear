...
<x-bear::heading.h1-section subtitle="A list of all permissions in the system.">Application Permissions
    <x-slot name="extra">
        <x-bear::button.dark icon="lock-closed" hx-get="/bear/access/permission/create">New Permission</x-bear::button.dark>
    </x-slot>
...
<x-bear::table.layout.standard>
    ...
    @foreach($permissions as $permission)
        <tr class="hover:bg-sky-50">
            ...
            <td class="px-2">
                <x-bear::button.outline icon="pencil" size="tiny" hx-get='{{"/bear/access/permission/$permission->permission_slug/update"}}'>Edit</x-bear::button.outline>
