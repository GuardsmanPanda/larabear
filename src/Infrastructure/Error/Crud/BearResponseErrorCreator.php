...
final class BearResponseErrorCreator {
    public static function create(
        ...
        try {
            ...
            (request_ip, user_id, request_country_code, response_status_code, request_method, request_path, request_query_json, request_content, request_hostname, app_action_name, response_body, request_id)
            VALUES (?, ?, ?, ? ,?, ?, ?, ?, ?, ?, ?, ?)",
                [Req::ip(), BearGlobalStateService::getUserId(), Req::ipCountry(), $statusCode, Req::method(), Req::path(), $query_json, $requestContent, Req::hostname(), Req::actionName(), $responseBody, BearGlobalStateService::getRequestId()]);
        } catch (Throwable $e) {
