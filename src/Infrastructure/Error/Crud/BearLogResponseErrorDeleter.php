...
class BearLogResponseErrorDeleter {
    public static function delete(
        ...
        DB::delete("DELETE FROM bear_log_response_error WHERE " . implode(' AND ', array_map(static fn ($key) => "$key = ?", array_keys($filters))), array_values($filters));
    }
}
