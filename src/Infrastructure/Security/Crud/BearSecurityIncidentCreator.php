...
class BearSecurityIncidentCreator {
    public static function create(
        ...
        DB::insert(query: "
            ...
            VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
        ", bindings: [$severity, $namespace, $headline, $description, $remediation, $reference, $causedByUserId, Req::ip(), Req::ipCountry(), Req::method(), Req::path(), $query_json, Req::hostname()]);
    }
}
