    ...
    public function up(): void {
        Schema::create(table: 'bear_external_api', callback: static function (Blueprint $table) {
            if (BearDatabaseService::defaultConnectionDriver() === 'pgsql') {
                ...
                $table->string(column: 'external_api_type_enum');
                $table->string(column: 'encrypted_token', length: 4096)->nullable();
                $table->string(column: 'base_url')->nullable();
                $table->string(column: 'oauth2_client_id')->nullable();
            }
